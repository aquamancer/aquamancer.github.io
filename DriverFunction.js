...
export function output(command) {
    ...
    const dictEngs = [[["hm"], ["cd"], ["kbw", "keen blunt"], ["doe", "DOE"], ["aoa", "AOA", "all-out attack"], ["barri"], ["vph, VPH"], ["rc", "RC"], ["ep", "EP"], ["mb", "MB"], ["mi", "MI", "mass", "increase mass"], ["am", "AM"], ["sa", "SA"]], ["hit master", "cursed doll", "keen blunt weapon", "drops of ether", "all out attack", "barricade", "vital point hit", "raid captain", "ether predator", "master brawler", "mass increase", "ambush master", "spirit absorption"]];
